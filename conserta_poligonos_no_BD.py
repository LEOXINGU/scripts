 ...
 ***************************************************************************/
"""
# Conserta Poligonos invalidos direto no banco (nos duplicados, filetes, e ziguezagues)
##Conserta Poligonos no BD=name
##LF4) Vetor=group
##Camada_de_entrada=vector
##Tolerancia_para_area_minima=number 0
...
poligonos = processing.getObject(Camada_de_entrada)
